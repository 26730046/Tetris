...
\begin{table}[H]
    \centering
    \caption{Bảng phím điều khiển trong phiên bản hiện tại (chỉ nhận phím chữ thường)}
    ...
    \begin{tabular}{|c|c|p{7cm}|}
        ...
        \hline
        1 & \texttt{a} & Di chuyển khối sang trái \\
        \hline
        2 & \texttt{d} & Di chuyển khối sang phải \\
        \hline
        3 & \texttt{x} & Tăng tốc độ rơi (Soft Drop) \\
        \hline
        4 & \texttt{w} & Xoay khối 90° theo chiều kim đồng hồ (Rotate) \\
        \hline
        5 & \texttt{q} & Thoát khỏi trò chơi (Quit) \\
        \hline
    \end{tabular}
\end{table}
